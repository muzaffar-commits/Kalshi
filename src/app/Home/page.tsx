...
import blockimg1 from '../../../public/img/zohran.png';
...
<div className="max-w-[1268px] mx-auto px-4 mt-20 lg:mt-50">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 pt-10 lg:pt-0">
        <div className="border border-gray-200 relative min-h-48 rounded-xl p-4 hover:shadow-md transition">
          <div className="flex items-center mb-3">
            <Image src={blockimg1} width={40}
              height={40}
              alt="trending"
              className="mr-2 rounded border border-gray-300" />
          ...
          <div className="text-xs mt-4">
              <div className="flex justify-between items-center text-gray-700">
                ...
                <div className="flex items-center gap-1">
                  <span className="text-lg font-semibold">81%</span>
          ...
          {/* Footer */}
              ...
              <span>$500k vol.</span>
              <span><a href="#" onClick={() => setIsOpen(true)} className="text-black/80">
    <svg
    ...
    >
      ...
      />
         ...
         {/* block2 start */}
          <div className="border border-gray-200 relative min-h-48 rounded-xl p-4 hover:shadow-md transition">
            <div className="flex items-center mb-3">
              ...
              />
              <h2 className="font-semibold text-sm text-gray-800">Can AI generate original artwork?</h2>
            </div>
        ...
        className="flex-1 bg-[#0099FF]/40 hover:bg-[#0099FF]/60 text-white py-1 rounded-md text-md transition-colors duration-150 cursor-pointer"
      >
        Buy Yes ↑
      </button>
      
      <h5 className='text-gray-400 mt-2 text-sm text-center'>$100 → <span className='text-[#0099FF]'>$1,563</span></h5>
      {/* Modal */}
      <ModalWithTabs
        isOpen={isModalOpen}
      ...
      />
              ...
              <button onClick={() => setIsModalOpen(true)} className="flex-1 bg-cyan-600/30
               hover:bg-cyan-600/60 text-[#0099FF] py-1 rounded-md text-md cursor-pointer">Buy No ↓</button>
              <h5 className='mt-2 text-sm text-center text-gray-400'>$100 → <span className='text-[#0099FF]'>$105</span></h5>
              </div>
            </div>
            <div className="flex absolute bottom-3 w-[88%] align-baseline justify-between text-xs text-gray-400">
              <span>$500k vol.</span>
              <span><a href="#" onClick={() => setIsOpen(true)}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="text-gray-600"
                className="w-4 h-4">

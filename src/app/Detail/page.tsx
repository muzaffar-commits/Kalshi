  ...
  <div className="max-w-[1268px] mx-auto px-4 mt-24 lg:mt-40">
    <div className="container mx-auto p-3 lg:p-6">
          <div className="md:flex lg:items-center mb-6">
            <Image src="/img/blockimg1.jpg" alt="NYC Flag" width={80} height={80} className="mr-4 rounded-lg" />
            <div>
              <h1 className="text-xl lg:text-2xl font-bold text-white">New York City Mayoral Election</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="md:col-span-2 space-y-6">
              ...
              <div className="md:flex items-center justify-between text-center px-2 md:px-0 py-3 md:py-0 border rounded-lg border-[#334661] md:border-0 bg-[#162033] lg:bg-transparent">
                <div className="flex items-center justify-start mb-3 lg:mb-0">
                  <Image src="/img/andrew.jpg" alt="Andrew Cuomo" width={40} height={40} className="w-12 h-12  rounded-lg bg-white border border-gray-400" />
                  <div className='text-white text-md lg:text-lg font-bold ml-3 text-left'>Andrew Cuomo</div>
                </div>
                <div className="flex space-x-2 justify-between">
                  <button className="bg-red-700/40 text-red-600 w-50 lg:w-auto px-3 font-bold py-1 rounded">Sell 23¢</button>
                  <button className="bg-green-600/40 text-green-500 w-50 lg:w-auto font-semibold px-3 py-1 rounded">Buy 77¢</button>
                </div>
              </div>

              <div className="md:flex items-center justify-between text-center px-2 md:px-0 py-3 md:py-0 border rounded-lg border-[#334661] md:border-0 bg-[#162033] lg:bg-transparent">
                <div className="flex items-center justify-start mb-3 lg:mb-0">
                  <Image src="/img/zohran.png" alt="Zohran Mamdani" width={40} height={40} className="w-12 h-12  rounded-lg bg-white border border-gray-400" />
                  <div className='text-white text-md lg:text-lg font-bold ml-3 text-left'>Zohran Mamdani</div>
                </div>
                <div className="flex space-x-2 justify-between">
                  <button className="bg-red-700/40 text-red-600 w-50 lg:w-auto px-3 font-bold py-1 rounded">Sell 23¢</button>
                  <button className="bg-green-600/40 text-green-500 w-50 lg:w-auto font-semibold px-3 py-1 rounded">Buy 77¢</button>
              ...
              <div className="md:flex items-center justify-between text-center px-2 md:px-0 py-3 md:py-0 border rounded-lg border-[#334661] md:border-0 bg-[#162033] lg:bg-transparent">
                <div className="flex items-center justify-start mb-3 lg:mb-0">
                  <Image src="/img/zohran.png" alt="Andrew Cuomo" width={40} height={40} className="w-12 h-12  rounded-lg bg-white border border-gray-400" />
                  <div className='text-white text-md lg:text-lg font-bold ml-3 text-left'>Zohran Mamdani</div>
                </div>
                <div className="flex space-x-2 justify-between">
                  <button className="bg-red-700/40 text-red-600 w-50 lg:w-auto px-3 font-bold py-1 rounded cursor-pointer">Sell 23¢</button>
                  <button className="bg-green-600/40 text-green-500 lg:w-auto w-50 font-semibold px-3 py-1 rounded cursor-pointer">Buy 77¢</button>
                </div>
              </div>
            </div>
            ...
            <div className="md:col-span-1 border border-[#334661] rounded-lg p-3 lg-p-6">
              <h2 className="text-xl font-bold mb-4 text-white">New York City Election</h2>
              <div className="space-y-3 mb-4">
                <button className="w-full bg-red-700 py-2 px-3 text-left rounded text-white font-semibold">Zohran Mamdani</button>
                <button className="w-full bg-blue-600 py-2 px-3 text-left rounded text-white font-semibold">Andrew Cuomo</button>
              ...
              <button className="w-full bg-purple-700 py-3 rounded font-bold text-white text-lg">TRADE</button>

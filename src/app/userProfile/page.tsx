  ...
  return (
    <>
      <div className="dark:bg-[#0f172a] mt-44">
        <div className="max-w-[800px] mx-auto px-4 mt-24 lg:mt-28">
          <div className="md:flex justify-between">
            <div className="md:w-3/4 flex md:mb-0 mb-4"><div>
              <Image
                src="/img/nick.jpg"
                alt="NYC Flag"
                width={80}
              ...
              <div>
                <h2 className="dark:text-white text-black font-bold text-xl">Meche8282</h2>
                <p className="dark:text-gray-500 text-gray-400 text-sm">Joined Dec 2025</p>
                <p className="text-gray-200 mt-3 text-sm flex">
                  <span className="me-3 text-gray-500">
                    <span className="dark:text-white text-gray-800 font-semibold">1.5k</span> Following
                  </span>

                  <span className="me-3 text-gray-500">
                    <span className="dark:text-white text-gray-800 font-semibold">4.5k</span> Followers
                  </span>

                  <span className="text-gray-500 ml-auto">
                    <span className="dark:text-white text-gray-800 font-semibold">75</span> Predictions
                  </span>
                </p>

              </div></div>
            <div className="md:w-1/4">
              <a href="#" className="dark:bg-gray-500 bg-gray-700 dark:text-white py-2 px-4 rounded-2xl text-sm font-semibold hover:bg-[#0099FF]">Edit Profile</a>
            </div>
          </div>
          <div className="md:mt-3 pt-3 border-t dark:border-gray-800 border-gray-300">
            <div className="flex justify-between items-center">
              <div className="flex items-center">
                ...
                <span className="dark:text-gray-400 text-gray-700 font-normal text-sm">Profit</span></div>
              <div><span className="bg-green-700 text-white py-1 px-4 text-sm">$1,760</span></div>
            </div>
          </div>
    ...
    <rect x="3" y="14" width="3" height="7" rx="1" fill="#008236"/>
    <rect x="8" y="11" width="3" height="10" rx="1" fill="#008236"/>
    <rect x="13" y="7" width="3" height="14" rx="1" fill="#008236"/>
    <rect x="18" y="3" width="3" height="18" rx="1" fill="#008236"/>
  </svg>
 </span>
                <span className="dark:text-gray-400 text-gray-700 font-normal text-sm">Volume</span></div>

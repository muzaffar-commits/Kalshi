    ...
    <>
      ...
      <div className="max-w-[1268px] mx-auto px-4">
        <div className="flex items-center justify-between py-3 relative">
          ...
          {/* Buttons */}
          <div className="flex items-center space-x-2">
            <button className="px-4 py-1 border border-purple-500 rounded-md hover:bg-gradient-to-r from-purple-500 to-pink-500 text-white font-bold">
              Log In
            </button>
         <button
  ...
  Sign Up
        ...
        {/* Navigation Links */}
          <nav className="border-b pb-2 border-gray-700 w-full hidden lg:block">
            <ul className="flex flex-wrap justify-evenly w-full px-4 py-2 text-[16px]">
              ...
              <li>
                <Link href="/blockdetail" className="text-[#8D9CB1] hover:text-purple-400">
                  New
                </Link>
              </li>
              <li>
        ...
        <nav className="w-full hidden lg:block">
          <ul className="flex flex-wrap justify-evenly w-full px-4 py-2 text-sm">
            <li>
            <a href="#" className="text-white font-semibold flex items-center px-4 py-1 rounded-xl
             bg-gradient-to-r from-purple-500 to-pink-500
             hover:bg-gradient-to-l hover:from-pink-500 hover:to-purple-500

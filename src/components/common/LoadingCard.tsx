...
const LoadingCard = () => {
  return (
    ...
    >
      ...
      {/* YES skeleton */}
      <div className="mt-4 p-3 rounded-xl bg-gray-100 dark:bg-[#1f2937]">
        ...
        <div className="mt-2 h-2 w-full bg-gray-300 dark:bg-gray-600 rounded" />
        <div className="mt-2 h-3 w-20 bg-gray-300 dark:bg-gray-600 rounded" />
      </div>

      {/* NO skeleton */}
      <div className="mt-3 p-3 rounded-xl bg-gray-100 dark:bg-[#1f2937]">
        <div className="flex justify-between">
          <div className="h-4 w-10 bg-gray-300 dark:bg-gray-600 rounded" />
          <div className="h-4 w-12 bg-gray-300 dark:bg-gray-600 rounded" />
        </div>

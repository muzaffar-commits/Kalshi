  ...
  return (
    <>
          <div className="dark:bg-[#0f172a] mt-40">
              <div className="max-w-[880px] mx-auto px-4 mt-36 lg:mt-28">
                  <div className="lg:flex">
                      <div className="md:w-1/4 w-full">
                          <h1 className="dark:text-white text-gray-800 lg:text-3xl text-xl mb-0 mt-3">Ideas</h1>
                          <span className="text-gray-500 text-xs">Serving public conversation</span>
                          <MobileMenu />
                      </div>

  ...
  return (
    <>
          <div className="dark:bg-[#0f172a]  bg-white text-gray-800 dark:text-gray-200 min-h-screen">
              <div className="max-w-[1268px] mx-auto px-4 pb-16 mt-40 lg:mt-36">
                  <div className='md:flex justify-between'>
                      ...
                      <div className='md:w-[54%] md:ml-[2%]'>
                          <div className='flex justify-between items-center mb-5'>
                              <div><h1 className="text-xl md:text-xl font-bold dark:text-gray-300 text-gray-700">
                                  Sports
                              </h1></div>
                          ...
                          <div className='border border-gray-200 dark:border-gray-700 dark:hover:border-[#c9ae79]/50 hover:border-gray-400 p-3 rounded-lg mb-3'>
                              <p className='text-gray-400 text-sm mb-4'><FaFootballBall className='inline-block' /> Chinese Basketball Association</p>
                              <div className="flex justify-between items-center mb-3">
                                  ...
                                  <div>
                                      <button className="py-1 px-4 border dark:border-[#c7ac77]/80 cursor-pointer border-gray-600 dark:text-[#c7ac77] text-gray-700 font-semibold rounded-md text-md">
                                          95%
                                      </button>
                                  </div>
                              </div>
                              <div className="flex justify-between items-center mb-3">
                                  ...
                                  <div>
                                      <button className="py-1 px-4 border dark:bg-[#c7ac77]/80 bg-gray-800 cursor-pointer dark:text-gray-800 text-gray-200 font-semibold rounded-md text-md">
                                          95%
                                      </button>
                                  </div>
                              </div>
                              <span className='text-gray-500 text-xs'>Jan 19 @ 6:35am EST</span>
                          </div>
                      ...
                      <div className='md:w-[25%] md:sticky md:top-28 h-fit'>
                          <div className='border border-gray-200 dark:border-gray-700 p-3 rounded-lg mb-3'>
                              <div className='flex justify-between gap-2'>
                                  ...
                                  <div><p className='text-[13px] dark:text-gray-400'>Beijing Royal Fighters at Guangzhou Loong Lions</p>
                                      <p className='text-sm font-semibold'><span className='dark:text-[#d1b37f] text-gray-800'>Buy Yes</span> · Beijing Royal Fighters</p>
                                  </div>
                              </div>
                              <div className='flex justify-between md:mt-5 mt-4 items-center'>
                                  <div className='flex gap-2'><button className="py-1 px-4 border dark:bg-[#c7ac77]/50 bg-gray-800 cursor-pointer dark:text-gray-950 text-gray-200 font-semibold rounded-md text-sm hover:bg-[#c7ac77]">
                                      Buy
                                  </button>
                              ...
                              <div className='border border-gray-200 dark:border-gray-700  p-3 rounded-md md:mt-7 flex justify-between items-center my-2'>
                                  <div><p className='dark:text-gray-400 text-gray-700 text-sm mb-2'>Contracts</p>
                                      <p className='dark:text-[#c7ac77] text-gray-700 text-[12px]'>Earn 3.5% Interest</p>
                                  </div>
                                  <div>
                                      <p className='font-semibold text-2xl dark:text-gray-300 text-gray-900'>0</p>
                                  </div>
                              </div>
                              <div className='border border-gray-200 dark:border-gray-700  p-3 rounded-md md:mt-3 flex justify-between items-center my-2'>
                                  <div>
                                      <p className='dark:text-[#c7ac77] text-gray-700 text-[12px]'>Limit price <FaExclamationCircle className='inline-block' /></p>
                                  </div>
                                  <div>
                                      <p className='font-semibold text-2xl dark:text-gray-300 text-gray-900'>0</p>
                                  </div>

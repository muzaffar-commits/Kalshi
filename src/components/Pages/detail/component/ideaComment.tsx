    ...
    <>
      ...
      <div className="flex-1">
        ...
        <p className="mt-1 text-sm text-gray-800 dark:text-gray-300 leading-relaxed">
          latest update: the aircraft carriers Bush and Lincoln have gone quiet.
          they are no longer broadcasting positions. 13 tankers sortied across
          the pond today with 8 more entourage. THAAD&apos;s and patriots are being
          moved into theater as well. F-15&apos;s arrived in Jordan
        </p>

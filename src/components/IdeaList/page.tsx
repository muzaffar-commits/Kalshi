...
export default function MobileMenu() {
  ...
  return (
      <div className="relative">
        ...
        ${open ? "translate-x-0" : "-translate-x-full"} md:static md:translate-x-0 md:w-auto md:bg-transparent`}
          >
              ...
              <Link href="#" className="bg-[#c8aa76] hover:bg-[#c8aa76]/80 py-2 px-4 text-md text-black rounded mt-3 lg:w-1/2 w-full lg:inline-block block text-center font-semibold">Post</Link>
          </ul>
      </div>
  );
}
...
function MenuItem({ icon, label }) {
  return (
      <li className="my-4 text-sm">
          <a href="#" className="flex items-center gap-3 dark:text-gray-300 text-gray-700 dark:hover:text-[#c8aa76] hover:text-[#c8aa76]">
